...
public class FamilleService {
	...
	@Produces(MediaType.APPLICATION_XML)
	public Personne getPersonne(@PathParam("famillyName") String famillyName, @PathParam("personName") String personName){
		System.out.println("Person Service Activated");
		return families.get(famillyName).getFamilyMembers().get(personName);
	}
}
